...
function setupEventListeners() {
    ...
    document.addEventListener('click', function(e) {
        if (e.target.classList.contains('vitals-tab-btn')) {
...
function switchVitalsTab(tabType) {
    ...
    document.getElementById('currentVitalsTab').style.display = tabType === 'current' ? 'block' : 'none';
    document.getElementById('previousVitalsTab').style.display = tabType === 'previous' ? 'block' : 'none';
}
